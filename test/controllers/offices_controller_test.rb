...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { phone: @office.phone, project_id: @office.project_id, street: @office.street, zip: @office.zip } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { phone: @office.phone, project_id: @office.project_id, street: @office.street, zip: @office.zip } }
